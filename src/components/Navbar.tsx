      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-center lg:justify-between h-16 sm:h-20 relative">
          <Link to="/" className="flex items-center gap-3 lg:absolute lg:left-0">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-black tracking-tighter bg-gradient-to-r from-black via-red-500 via-green-500 to-black bg-clip-text text-transparent">
                MKENYA
              </h1>

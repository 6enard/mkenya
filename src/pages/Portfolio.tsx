...
export default function Portfolio() {
  ...
  const portfolio = [
    { id: 1, category: 'design', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQjBjWMxOl-BpELQYf6ZHTiIsbEpK3gICH2wg&s', title: 'Standard Chartered Bank', span: 'sm:row-span-2', description: 'Spatial design for activation agency managing annual reports, showcase booths, and VIP areas' },
    { id: 2, category: 'social-media', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ1Zp75KbuW8HS3lR1JxQR3XGqutHd1McS2Gg&s', title: 'Momentum Credit', span: 'sm:col-span-2', description: 'Year-long social media contract ensuring consistent brand application across sub-brands' },
    ...
    { id: 5, category: 'design', image: 'https://images.pexels.com/photos/3760072/pexels-photo-3760072.jpeg?auto=compress&cs=tinysrgb&w=800', title: 'Chemraw EA LTD', span: 'sm:row-span-2', description: 'Company profile design for chemical manufacturing and distribution' },
    { id: 6, category: 'branding', image: 'https://lak.co.ke/wp-content/uploads/2024/07/LEMIK.jpg', title: 'Lemik Leasing Ltd', span: '', description: 'Complete brand architecture from logo to website for female-founded company' },
    { id: 7, category: 'branding', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRV2lJCxW3E9TCNTIgVVMr9coqfsLKLHBIXUw&s', title: 'Aspirelle Business', span: '', description: 'Brand design for financial training practice targeted at women' },
    { id: 8, category: 'legal', image: 'https://images.pexels.com/photos/5668772/pexels-photo-5668772.jpeg?auto=compress&cs=tinysrgb&w=800', title: 'Banja & Co. Advocates', span: 'sm:col-span-2', description: 'Complete branding and portfolio design for a legal practice' },
